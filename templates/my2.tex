...
% \SetWatermarkText{\shortstack{鑫亿技术文档\\注意保密}}
...
\else % if luatex or xelatex
  ...
  \punctstyle{quanjiao}
  \setCJKmainfont{Songti TC}%Songti TC,PingFang SC
...
\titleformat{\chapter}[display]{\Large\bf}{\chaptername}{20pt}{}
\titleformat{\section}[display]{\large\bf}{\thesection}{10pt}{}
